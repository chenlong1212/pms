...
const moduleSelectors=['.metric-cards','.module-video','.biomass-section','.twin-stage','.module-chat','.system-entry']
const moduleNames:Record<string,string>={'.metric-cards':'水质指标（pH / 水温 / 溶解氧）','.module-video':'视频监控','.biomass-section':'生物量估计与计数','.twin-stage':'3D 池塘模型','.module-chat':'智能体','.system-entry':'外部系统入口（6项）'}
